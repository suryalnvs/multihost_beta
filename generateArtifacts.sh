...
function generateChannelArtifacts() {
	...
	echo "#################################################################"
	$CONFIGTXGEN -profile TwoOrgsChannel -outputCreateChannelTx ./channels/mychannel0.tx -channelID ${CHANNEL_NAME}0
        $CONFIGTXGEN -profile TwoOrgsChannel -outputCreateChannelTx ./channels/mychannel1.tx -channelID ${CHANNEL_NAME}1
